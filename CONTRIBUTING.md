...
Falcon does not accept Pull Requests (PRs) _for new functionality_ from users that are not currently part of the
...
If you've found what you believe is a security issue please email `support.falcon@gmail.com`. Please check
...
You can also find us on [Discord](https://discord.gg/falcon-panel).
